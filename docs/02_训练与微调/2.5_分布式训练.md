<div style="text-align: center; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;"><strong>分布式训练</strong></div>
...
# 18. 在 Qwen2.5-0.5B-Instruct 微调中的应用
...
# 22. 4 Hugging Face PEFT 实现步骤（M4 环境）

...
## 3.1.2. 核心技术：PagedAttention
### 3.1.2.1. KV Cache碎片化问题
### 3.1.2.2. 分页管理原理

## 3.1.3. 连续批处理（Continuous Batching）
...
## 3.1.5. 性能调优
### 3.1.5.1. max_model_len 设置
### 3.1.5.2. gpu_memory_utilization
### 3.1.5.3. 量化集成

## 3.1.6. 实测数据（太初8卡国产GPU）
